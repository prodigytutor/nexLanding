  ...
  return (
    ...
    <div className="container">
      <div className="md:flex items-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-6">AI Interviewz, your pathway to success</h1>
